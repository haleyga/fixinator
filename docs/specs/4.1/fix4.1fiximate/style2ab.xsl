...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
	...
	<xsl:template match="/">
		<HTML>
		<BODY bgcolor="e8e8e8">
			<A HREF="msg_num.xml"><FONT face="Arial" color="#006699"><small>Sort Numerically</small></FONT></A>
			<P>
			<TABLE border="0" cellspacing="0" cellpadding="5">
				<xsl:apply-templates select="//TAG"  order-by="+fieldName" />
			</TABLE>
			</P>
			<A HREF="msg_num.xml">Sort Numerically</A>	
		</BODY>
		</HTML>
	</xsl:template>
