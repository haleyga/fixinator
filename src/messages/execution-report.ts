...
export class ExecutionReportMessage extends BaseApplicationMessage implements IExecutionReportMessage {
    ...
    public get execId(): IExecutionIdField {
        return this._execId;
    }

    public set execId(value: IExecutionIdField) {
        this._execId = value;
    }
    public get execTransType(): IExecutionTransactionTypeField {
        return this._execTransType;
    }

    public set execTransType(value: IExecutionTransactionTypeField) {
        this._execTransType = value;
    }
    public get ordStatus(): IOrderStatusField {
        return this._ordStatus;
    }

    public set ordStatus(value: IOrderStatusField) {
        this._ordStatus = value;
    }
    public get ordRejReason(): IOrderRejectionReasonField {
        return this._ordRejReason;
    }

    public set ordRejReason(value: IOrderRejectionReasonField) {
        this._ordRejReason = value;
    }
    ...
    public get lastShares(): ILastSharesField {
        return this._lastShares;
    }

    public set lastShares(value: ILastSharesField) {
        this._lastShares = value;
    }
    public get lastPx(): ILastPriceField {
        return this._lastPx;
    }

    public set lastPx(value: ILastPriceField) {
        this._lastPx = value;
    }
    public get lastMkt(): ILastMarketField {
        return this._lastMkt;
    }

    public set lastMkt(value: ILastMarketField) {
        this._lastMkt = value;
    }
    public get lastCapacity(): ILastCapacityField {
        return this._lastCapacity;
    }

    public set lastCapacity(value: ILastCapacityField) {
        this._lastCapacity = value;
    }
    ...
    public get transactTime(): ITransactionTimeField {
        return this._transactTime;
    }

    public set transactTime(value: ITransactionTimeField) {
    ...
    public validate(): boolean {
        ...
        return this._msgType.formatted === MESSAGE_TYPES.execution_report;
    }
