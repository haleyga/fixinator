...
import {
    IListExecuteMessage, IProtoListExecuteMessage, ListExecuteMessage, ProtoListExecuteMessage,
} from '../../messaging/messages/list-execute';
...
export class ListExecuteMessageBuilder extends BaseMessageBuilder implements IListExecuteMessageBuilder {
    ...
    protected _protoMessage: IProtoListExecuteMessage = null;
    ...
    protected finalizeAndEmitMessage(): void {
        ...
        const type    = MESSAGE_TYPE.list_execute;
        const message = new ListExecuteMessage(this._protoMessage);
