...
import { ISendingDateField, SendingDateField } from './sending-date';
...
describe('sending-date.spec.ts', function () {
    ...
    describe('SendingDateField', () => {
            ...
            for (let year = 0; year <= MAX_TWO_DIGIT_YEAR; year++) {
                for (let month = 1; month <= MAX_MONTH; month++) {
                    ...
                    for (let day = 1; day <= maxDayInMonth; day++) {
                        ...
                        const dateField   = new SendingDateField(`${yearString}${monthString}${dayString}`);
        ...
        it(`should fail to parse invalid FIX dates`, (done) => {
            ...
            let dateField: ISendingDateField = null;

            try {
                dateField = new SendingDateField(`24:00:00`);
                dateField.validate();
            } catch (error) {
            ...
            try {
                dateField = new SendingDateField(`999999`);
                dateField.validate();
            } catch (error) {
                chai.expect(error).to.be.an.instanceof(FixinatorParseError);
            }
            ...
            try {
                dateField = new SendingDateField(`-1`);
                dateField.validate();
            } catch (error) {
                chai.expect(error).to.be.an.instanceof(FixinatorParseError);
            }
            ...
            try {
                dateField = new SendingDateField(`a`);
                dateField.validate();
            } catch (error) {
                chai.expect(error).to.be.an.instanceof(FixinatorParseError);
            }
            ...
            try {
                dateField = new SendingDateField(`0000000`);
                dateField.validate();
            } catch (error) {
                chai.expect(error).to.be.an.instanceof(FixinatorParseError);
            }
            ...
            try {
                dateField = new SendingDateField(``);
                dateField.validate();
            } catch (error) {
                chai.expect(error).to.be.an.instanceof(FixinatorParseError);
            }
            ...
            try {
                dateField = new SendingDateField(`08/08/2017`);
                dateField.validate();
            } catch (error) {
                chai.expect(error).to.be.an.instanceof(FixinatorParseError);
            }
            ...
            try {
                dateField = new SendingDateField(`08/08/17`);
                dateField.validate();
            } catch (error) {
                chai.expect(error).to.be.an.instanceof(FixinatorParseError);
            }
