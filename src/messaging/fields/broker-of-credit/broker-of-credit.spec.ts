...
import { BrokerOfCreditField } from './broker-of-credit';

describe('broker-of-credit.spec.ts', () => {

    describe('BrokerOfCreditField', () => {
        it('should construct a field with valid raw data', (done) => {
            const raw   = 'a standard raw char field';
            const field = new BrokerOfCreditField(raw);
            field.validate();
        ...
        it('should fail to validate a field with invalid raw data', (done) => {
            try {
                const field = new BrokerOfCreditField(`${STANDARD_DELIMITER}`);
                field.validate();
            } catch (error) {
